...
namespace TerraCode.Repository
{
    public class PLRepository
    {
        ...
        public bool CreatePL(string nome, int fazendaId, string dataDoPlantio, float hectarePlantados, string observacoes)
        {
            try
            {
                string query = "INSERT INTO PLs (Nome, FazendaId, DataDoPlantio, HectarePlantados, Observacoes) " +
                               "VALUES (@Nome, @FazendaId, @DataDoPlantio, @HectarePlantados, @Observacoes)";
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            PL pl = new PL
                            {
                                ...
                                Nome = reader.GetString(reader.GetOrdinal("Nome")),
                                FazendaId = reader.GetInt32(reader.GetOrdinal("FazendaId")),
                                // Note que DataDoPlantio agora é nullable, sem casting direto
                                DataDoPlantio = reader.GetString(reader.GetOrdinal("DataDoPlantio")),
                                HectarePlantados = Convert.ToSingle(reader.GetValue(reader.GetOrdinal("HectarePlantados"))),
                                Observacoes = reader.GetString(reader.GetOrdinal("Observacoes"))
                            };
        ...
        public bool UpdatePL(int id, string nome, int fazendaId, DateTime dataDoPlantio, float hectarePlantados, string observacoes)
        {
            try
            {
                string query = "UPDATE PLs SET Nome = @Nome, FazendaId = @FazendaId, DataDoPlantio = @DataDoPlantio, " +
                               "HectarePlantados = @HectarePlantados, Observacoes = @Observacoes WHERE Id = @Id";
